...
HD_PWD='D:/My Projects/VerilogProj_2013631/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log multiply.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source multiply.tcl -notrace
