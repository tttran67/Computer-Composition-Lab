...
module regfile(
    input             clk,
    input             wen,
    input      [4 :0] raddr1,//地址，给CPU用
    input      [4 :0] raddr2,//地址，给CPU用
    input      [4 :0] waddr,//写在哪个寄存器
    input      [31:0] wdata,//写的数据
    output reg [31:0] rdata1,//数据
    output reg [31:0] rdata2,//数据
    input      [4 :0] test_addr,//给LED屏
    output reg [31:0] test_data//给LED屏
    );
    reg [31:0] rf[31:0];
