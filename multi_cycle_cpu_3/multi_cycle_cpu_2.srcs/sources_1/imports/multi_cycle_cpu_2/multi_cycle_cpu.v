...
module multi_cycle_cpu(  // 多周期cpu
    ...
    //!!!!!!add
    output [31:0] my_jbr_target,
//    output [2:0] my_next_state,
//    output [31:0] inst_addr
//    output [31:0] my_pc,
    output [31:0] my_next_pc
//    output [31:0] my_if_jbr_target
    );
//----------------------{控制多周期的状态机}begin------------------------//
    reg [2:0] state;       // 当前状态
    ...
    //展示当前处理器正在执行哪个模块
//    assign display_state = {3'd0,state};
    assign display_state = state;//////////!!!!!!!!!!add
    // 状态机状态
...
//    assign my_next_state = next_state;
    //5模块的valid信号
    wire IF_valid;
    wire ID_valid;
    wire EXE_valid;
...
//        .jbr_target(my_if_jbr_target)
    ...
    decode ID_module(               // 译码级
        ...
        //展示PC
        .ID_pc      (ID_pc      ),
        .my_jbr_target (my_jbr_target)//!!!!!!!!add
    );
