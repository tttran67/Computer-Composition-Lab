...
module decode(                      // 译码级
    ...
    output     reg   ID_over,     // ID模块执行完成
    output    [149:0]  ID_EXE_bus,  // ID->EXE总线
    
    //展示PC
    output     [ 31:0] ID_pc,
    //!!!add
    output [32:0] my_jbr_target
);
//-----{IF->ID总线}begin
    wire [31:0] pc;
    wire [31:0] inst;
...
//    assign br_target[31:2] = pc[31:2] + {{14{offset[15]}}, offset};  
    assign br_target[31:2] = pc[31:2] + {{14{offset[15]}}, offset}; //!!!!!add
    ...
    assign my_jbr_target = jbr_target;
    //ID到IF的跳转总线
