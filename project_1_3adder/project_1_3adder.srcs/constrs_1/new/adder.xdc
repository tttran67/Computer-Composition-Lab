...
set_property PACKAGE_PIN H7   [get_ports led_coutlow]
set_property PACKAGE_PIN D5   [get_ports led_couthigh]
set_property PACKAGE_PIN Y3   [get_ports resetn]
set_property PACKAGE_PIN AC21 [get_ports input_sel]
set_property PACKAGE_PIN AC22 [get_ports input_sel3]
set_property PACKAGE_PIN AD24 [get_ports sw_cinlow]
set_property PACKAGE_PIN AC23 [get_ports sw_cinhigh]

set_property IOSTANDARD LVCMOS33 [get_ports clk]
set_property IOSTANDARD LVCMOS33 [get_ports led_coutlow]
set_property IOSTANDARD LVCMOS33   [get_ports led_couthigh]
set_property IOSTANDARD LVCMOS33 [get_ports resetn]
set_property IOSTANDARD LVCMOS33 [get_ports input_sel]
set_property IOSTANDARD LVCMOS33 [get_ports input_sel3]
set_property IOSTANDARD LVCMOS33 [get_ports sw_cinlow]
set_property IOSTANDARD LVCMOS33 [get_ports sw_cinhigh]
